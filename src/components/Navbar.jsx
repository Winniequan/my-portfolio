...
const Navbar = () => {
  ...
  return (
    <div className="fixed w-full h-[80px] flex justify-between items-center px-4 bg-purple-900 text-gray-300">
      <div>
        <h1 className="text-5xl font-mono">YQ</h1>
      </div>
      {/* menu */}
      ...
      <ul
        className={
          !nav
            ? "hidden"
            : "absolute top-0 left-0 w-full h-screen bg-purple-900 flex flex-col justify-center items-center"
        }
      >
        ...
        <ul>
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-blue-600">
            <a
              ...
              href="http://www.linkedin.com/in/ying-quan-066028207"
            >
              Linkedin
              <FaLinkedin size={30} />
            </a>
          ...
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#333333]">
            <a
              className="flex justify-between items-center w-full text-gray-300"
              href="http://github.com/Winniequan"
            >
              Github
              <FaGithub size={30} />
            </a>
